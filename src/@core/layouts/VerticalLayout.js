  ...
  return (
    ...
    >
      ...
      <Navbar
        ...
        style={{background:"#ffffff00", boxShadow:"none"}}
      >
        <div className='navbar-container d-flex content' style={{background: "linear-gradient(to left, #46678F, #4B6F9B, #527BAC)", borderRadius:"30px"}}>
          <p className='user-nav d-sm-flex d-none' style={{ marginTop:"10px", marginBottom:"0px"}}><span style={{color:"white", fontWeight:"bold"}}>Buen día, {(userData && userData['username']) || ''} </span> </p>
          {navbar ? (
